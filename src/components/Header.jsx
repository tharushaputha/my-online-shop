...
// --- Menu Items List Definitions (Component එකෙන් එළියේ define කරන්න ඕන) ---
  ...
  return (
    <header className="bg-secondary shadow-md sticky top-0 z-50">
      <nav className="container mx-auto px-4 py-3 flex justify-between items-center">
        {/* Logo */}
        <Link href="/"> <Image src="/logo.png" alt="Kitto Logo" width={120} height={40} priority /> </Link>

        {/* Hotline */}
        <div className="hidden md:flex items-center space-x-2 text-gray-800 font-semibold"> <FaPhoneAlt className="w-4 h-4" /> <span>{hotline}</span> </div>

        {/* Desktop Menu */}
        <div className="hidden md:flex items-center space-x-2 md:space-x-4">
           {/* Desktop buttons code... */}
